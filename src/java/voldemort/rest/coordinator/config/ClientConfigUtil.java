...
public class ClientConfigUtil {
    ...
    public static Properties readSingleClientConfigAvro(String configAvro) {
        ...
        try {
            JsonDecoder decoder = AvroMigrationHelper.newJsonDecoder(CLIENT_CONFIG_AVRO_SCHEMA, configAvro); // new JsonDecoder(CLIENT_CONFIG_AVRO_SCHEMA, configAvro);
    ...
    public static Map<String, Properties> readMultipleClientConfigAvro(String configAvro) {
        ...
        try {
            JsonDecoder decoder = AvroMigrationHelper.newJsonDecoder(CLIENT_CONFIGS_AVRO_SCHEMA, configAvro); //new JsonDecoder(CLIENT_CONFIGS_AVRO_SCHEMA, configAvro);
