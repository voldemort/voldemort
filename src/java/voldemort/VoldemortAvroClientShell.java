        ...
        for(String line = reader.readLine(); line != null; line = reader.readLine()) {
            ...
            try {
                if(line.toLowerCase().startsWith("get")) {
                    ...
                    JsonDecoder keyDecoder = DecoderFactory.get().jsonDecoder(keySchema, keyString);
                    JsonDecoder valueDecoder = DecoderFactory.get().jsonDecoder(valueSchema, valueString);
