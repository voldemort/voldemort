        ...
        for(String line = reader.readLine(); line != null; line = reader.readLine()) {
            ...
            try {
                if(line.toLowerCase().startsWith("get")) {
                    ...
                    JsonDecoder decoder = AvroMigrationHelper.newJsonDecoder(keySchema, line); // new JsonDecoder(keySchema, line);
                    ...
                    JsonDecoder keyDecoder = AvroMigrationHelper.newJsonDecoder(keySchema, keyString); // new JsonDecoder(keySchema, keyString);
                    JsonDecoder valueDecoder = AvroMigrationHelper.newJsonDecoder(valueSchema, valueString); // new JsonDecoder(valueSchema, valueString);
