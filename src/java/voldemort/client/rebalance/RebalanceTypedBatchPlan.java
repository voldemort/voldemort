...
public abstract class RebalanceTypedBatchPlan {
    ...
    protected List<RebalancePartitionsInfo> rebalanceTasks;
    ...
    public RebalanceTypedBatchPlan(final RebalanceClusterPlan rebalanceClusterPlan) {
        ...
        this.rebalanceTasks = null;
    }

    // TODO: Add javadoc
    public List<RebalancePartitionsInfo> getRebalancingTasks() {
        return rebalanceTasks;
    }

    @Override
    public String toString() {
        if(rebalanceTasks.isEmpty()) {
            return "No rebalancing required since list of rebalance tasks is empty";
        }

        return RebalancePartitionsInfo.taskListToString(rebalanceTasks);
    }
}
