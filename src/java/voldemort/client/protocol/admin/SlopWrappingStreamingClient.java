 ...
 * 
 */
public class SlopWrappingStreamingClient extends StreamingClient {

    private static final Logger logger = Logger.getLogger(SlopWrappingStreamingClient.class);
    ...
    // used for callbacks
    ExecutorService streamingSlopResults;

    // the list of nodes which have been previously detected faulty
    ...
    public SlopWrappingStreamingClient(StreamingClientConfig config) {
        super(config);
        streamingSlopResults = Executors.newFixedThreadPool(3);
