...
public class ReadOnlyUtils {
    ...
    public static final String FULL_STORE_METADATA_FILE_PREFIX = "full-store";
    public static final String FULL_STORE_METADATA_FILE = FULL_STORE_METADATA_FILE_PREFIX + METADATA_FILE_EXTENSION;
