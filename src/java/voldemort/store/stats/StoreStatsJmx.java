...
public class StoreStatsJmx {
    ...
    @Attribute(name = "numberOfCallsToGetAll",
               description = "The number of calls to GET_ALL since the last reset.",
    ...
    @Attribute(name = "averageGetAllCompletionTimeInMs",
               description = "The avg. time in ms for GET_ALL calls to complete.",
               metricType = MetricType.GAUGE,
    ...
    @Attribute(name = "GetAllThroughput",
               description = "Throughput of GET_ALL requests.",
               metricType = MetricType.GAUGE,
    ...
    @Attribute(name = "numberOfCallsToGet",
               description = "The number of calls to GET since the last reset.",
               metricType = MetricType.GAUGE,
               dataType = DataType.LONG)
    ...
    @Attribute(name = "averageGetCompletionTimeInMs",
    ...
    @Attribute(name = "GetThroughput",
               description = "Throughput of GET requests.",
               metricType = MetricType.GAUGE,
               dataType = DataType.DOUBLE)
    ...
    @Attribute(name = "numberOfCallsToPut",
               description = "The number of calls to PUT since the last reset.",
               metricType = MetricType.GAUGE,
               dataType = DataType.LONG)
    ...
    @Attribute(name = "averagePutCompletionTimeInMs",
               description = "The avg. time in ms for PUT calls to complete.",
               metricType = MetricType.GAUGE,
               dataType = DataType.DURATION)
    ...
    @Attribute(name = "PutThroughput",
               description = "Throughput of PUT requests.",
               metricType = MetricType.GAUGE,
               dataType = DataType.DOUBLE)
    ...
    @Attribute(name = "numberOfCallsToDelete",
               description = "The number of calls to DELETE since the last reset.",
               metricType = MetricType.GAUGE,
               dataType = DataType.LONG)
    ...
    @Attribute(name = "averageDeleteCompletionTimeInMs",
               description = "The avg. time in ms for DELETE calls to complete.",
               metricType = MetricType.GAUGE,
               dataType = DataType.DURATION)
    ...
    @Attribute(name = "DeleteThroughput",
               description = "Throughput of DELETE requests.",
               metricType = MetricType.GAUGE,
               dataType = DataType.DOUBLE)
    ...
    @Attribute(name = "numberOfObsoleteVersions",
    ...
    @Attribute(name = "numberOfExceptions",
               description = "The number of exceptions since the last reset.",
               metricType = MetricType.GAUGE,
               dataType = DataType.LONG)
    ...
    @Attribute(name = "averageOperationTimeInMs",
               description = "The total nuber of all operations that have occured.",
               metricType = MetricType.GAUGE,
               dataType = DataType.DURATION)
    ...
    @Attribute(name = "AllOperationThroughput",
               description = "The number of exceptions since the last reset.",
               metricType = MetricType.GAUGE,
               dataType = DataType.DOUBLE)
    ...
    @Attribute(name = "percentGetReturningEmptyResponse",
               description = "The percentage of calls to GET for which no value was found.",
               metricType = MetricType.GAUGE,
    ...
    @Attribute(name = "percentGetAllReturningEmptyResponse",
               description = "The percentage of calls to GET_ALL for which no value was found, taking into account multiple returned key-values.",
               metricType = MetricType.GAUGE,
               dataType = DataType.PERCENT)
    ...
    @Attribute(name = "maxPutLatencyInMs",
               description = "Maximum latency in ms of PUT",
               metricType = MetricType.GAUGE,
               dataType = DataType.DURATION)
    ...
    @Attribute(name = "maxGetLatencyInMs",
               description = "Maximum latency in ms of GET",
               metricType = MetricType.GAUGE,
               dataType = DataType.DURATION)
    ...
    @Attribute(name = "maxGetAllLatencyInMs",
               description = "Maximum latency in ms of GET_ALL",
               metricType = MetricType.GAUGE,
               dataType = DataType.DURATION)
    ...
    @Attribute(name = "maxDeleteLatencyInMs",
               description = "Maximum latency in ms of DELETE",
               metricType = MetricType.GAUGE,
               dataType = DataType.DURATION)
    ...
    @Attribute(name = "maxPutSizeInBytes",
               description = "Maximum size of value returned in bytes by PUT.",
               metricType = MetricType.GAUGE,
    ...
    @Attribute(name = "maxGetAllSizeInBytes",
               description = "Maximum size of value returned in bytes by GET_ALL.",
               metricType = MetricType.GAUGE,
               dataType = DataType.STORAGE)
    ...
    @Attribute(name = "maxGetSizeInBytes",
               description = "Maximum size of value returned in bytes by GET.",
               metricType = MetricType.GAUGE,
               dataType = DataType.STORAGE)
    ...
    @Attribute(name = "averageGetValueSizeInBytes",
               description = "Average size in bytes of GET request",
               metricType = MetricType.GAUGE,
               dataType = DataType.STORAGE)
    ...
    @Attribute(name = "averageGetAllSizeInBytes",
               description = "Average size in bytes of GET_ALL request",
               metricType = MetricType.GAUGE,
               dataType = DataType.STORAGE)
    ...
    @Attribute(name = "averagePutSizeInBytes",
               description = "Average size in bytes of PUT request",
               metricType = MetricType.GAUGE,
               dataType = DataType.STORAGE)
