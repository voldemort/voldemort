...
public class AdminCommandDebug extends AbstractAdminCommand {
     ...
     */
    private static class SubCommandDebugQueryKeys extends AbstractAdminCommand {
         ...
         * 
         */
        private static void doDebugQueryKeys(AdminClient adminClient,
     ...
     * debug route command
     */
    private static class SubCommandDebugRoute extends AbstractAdminCommand {
         ...
         * 
         */
        private static void doDebugRoute(AdminClient adminClient,
                                         String storeName,
                                         List<String> keyStrings,
