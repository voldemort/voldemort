...
/**
 * A hadoop RawComparator that deserializes first. Usefull for sorting JSON objects
 * 
 * @author jay
 * 
 */
public class JsonDeserializerComparator implements RawComparator<BytesWritable>,
    Configurable
{
  ...
  {
    return this.compareBytes(o1.getBytes(),
                             0,
                             o1.getLength(),
                             o2.getBytes(),
                             0,
