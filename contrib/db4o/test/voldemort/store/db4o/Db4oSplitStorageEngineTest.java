 ...
 * 
 */
public class Db4oSplitStorageEngineTest extends TestCase {

    private File db4oMasterDir;
    private Db4oStorageConfiguration db4oStorage;
    ...
    protected void setUp() throws Exception {
        ...
        db4oMasterDir = TestUtils.createTempDir();
        FileDeleteStrategy.FORCE.delete(db4oMasterDir);
    }
    ...
    private long getMaxCacheUsage(EnvironmentConfig environmentConfig, DatabaseConfig databaseConfig)
        ...
        File dirA = new File(db4oMasterDir + "/" + "storeA");
        if(!dirA.exists()) {
            dirA.mkdirs();
        }
        ...
        File dirB = new File(db4oMasterDir + "/" + "storeB");
        if(!dirB.exists()) {
            dirB.mkdirs();
        }
