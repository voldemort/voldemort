...
public class VoldemortNativeV2BackwardCompatTest extends VoldemortNativeBackWardCompatTest {

    byte[][][] inputOutputCombination = new byte[][][] {
            // Request Format Type VOLDEMORT_V2
            ...
            { // Begin Input
                    new byte[] { 2, 0, 4, 116, 101, 115, 116, 0, 0, 0, 0, 0, 4, 107, 101, 121, 49,
                            ...
                            97, 78, 118, 97, 108, 117, 101, 49 }, new byte[] { 0, 0 } }, // End
                                                                                         // Output
            { // Begin Input
            ...
            { // Begin Input
                    new byte[] { 2, 0, 4, 116, 101, 115, 116, 0, 0, 0, 0, 0, 4, 107, 101, 121, 50,
                            ...
                            74, 78, 118, 97, 108, 117, 101, 50 }, new byte[] { 0, 0 } }, // End
                                                                                         // Output
            { // Begin Input
            ...
            { // Begin Input
                    new byte[] { 4, 0, 4, 116, 101, 115, 116, 0, 0, 0, 0, 0, 2, 0, 0, 0, 4, 107,
                            101, 121, 49, 0, 0, 0, 4, 107, 101, 121, 50 },
    ...
    public VoldemortNativeV2BackwardCompatTest() {
        super(RequestFormatType.VOLDEMORT_V2);
    }
}
