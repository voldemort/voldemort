...
public class HintedHandoffTest {
    ...
    private final Class<FailureDetector> failureDetectorCls;
    ...
    public HintedHandoffTest(Class<FailureDetector> failureDetectorCls) {
        this.failureDetectorCls = failureDetectorCls;
    }
