...
_UPDATEPARTITIONENTRIESREQUEST = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='overwriteIfLatest', full_name='voldemort.UpdatePartitionEntriesRequest.overwriteIfLatest', index=3,
