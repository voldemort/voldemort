...
_ADMINREQUESTTYPE = descriptor.EnumDescriptor(
  ...
  values=[
    ...
    descriptor.EnumValueDescriptor(
      ...
      type=None),
    descriptor.EnumValueDescriptor(
      name='INITIATE_REBALANCE_NODE_ON_DONOR', index=23, number=25,
      options=None,
      type=None),
  ],
...
INITIATE_REBALANCE_NODE_ON_DONOR = 25
...
_VOLDEMORTADMINREQUEST = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='initiate_rebalance_node_on_donor', full_name='voldemort.VoldemortAdminRequest.initiate_rebalance_node_on_donor', index=24,
