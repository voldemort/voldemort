...
_SLOPPURGEJOBREQUEST = descriptor.Descriptor(
  ...
  fields=[
    descriptor.FieldDescriptor(
      name='node_ids', full_name='voldemort.SlopPurgeJobRequest.node_ids', index=0,
      number=1, type=5, cpp_type=1, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='zone_id', full_name='voldemort.SlopPurgeJobRequest.zone_id', index=1,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='store_names', full_name='voldemort.SlopPurgeJobRequest.store_names', index=2,
...
_SLOPPURGEJOBRESPONSE = descriptor.Descriptor(
