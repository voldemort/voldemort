...
_UPDATEGRANDFATHERMETADATAREQUEST = descriptor.Descriptor(
  ...
  fields=[
    descriptor.FieldDescriptor(
      name='storesDef', full_name='voldemort.UpdateGrandfatherMetadataRequest.storesDef', index=0,
      number=1, type=9, cpp_type=9, label=2,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='plan', full_name='voldemort.UpdateGrandfatherMetadataRequest.plan', index=1,
