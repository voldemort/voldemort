...
_ADMINREQUESTTYPE = descriptor.EnumDescriptor(
  ...
  values=[
    ...
    descriptor.EnumValueDescriptor(
      ...
      type=None),
    descriptor.EnumValueDescriptor(
      name='FETCH_PARTITION_FILES', index=16, number=18,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='UPDATE_SLOP_ENTRIES', index=17, number=20,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='FAILED_FETCH_STORE', index=18, number=22,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='GET_RO_METADATA', index=19, number=23,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='REBALANCE_STATE_CHANGE', index=20, number=24,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_REBALANCEPARTITIONINFOMAP = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='unbalanced_stores', full_name='voldemort.RebalancePartitionInfoMap.unbalanced_stores', index=2,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='attempt', full_name='voldemort.RebalancePartitionInfoMap.attempt', index=3,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='replica_to_partition', full_name='voldemort.RebalancePartitionInfoMap.replica_to_partition', index=4,
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='replica_to_delete_partition', full_name='voldemort.RebalancePartitionInfoMap.replica_to_delete_partition', index=6,
...
_ROMETADATAMAP = descriptor.Descriptor(
  name='ROMetadataMap',
  full_name='voldemort.ROMetadataMap',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='store_name', full_name='voldemort.ROMetadataMap.store_name', index=0,
      number=1, type=9, cpp_type=9, label=2,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='value', full_name='voldemort.ROMetadataMap.value', index=1,
      number=2, type=9, cpp_type=9, label=2,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETROMETADATAREQUEST = descriptor.Descriptor(
  name='GetROMetadataRequest',
  full_name='voldemort.GetROMetadataRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='store_name', full_name='voldemort.GetROMetadataRequest.store_name', index=0,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='type', full_name='voldemort.GetROMetadataRequest.type', index=1,
...
_GETROMETADATARESPONSE = descriptor.Descriptor(
  name='GetROMetadataResponse',
  full_name='voldemort.GetROMetadataResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='ro_store_metadata', full_name='voldemort.GetROMetadataResponse.ro_store_metadata', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='error', full_name='voldemort.GetROMetadataResponse.error', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_VOLDEMORTADMINREQUEST = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='fetch_partition_files', full_name='voldemort.VoldemortAdminRequest.fetch_partition_files', index=17,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='update_slop_entries', full_name='voldemort.VoldemortAdminRequest.update_slop_entries', index=18,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='failed_fetch_store', full_name='voldemort.VoldemortAdminRequest.failed_fetch_store', index=19,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='get_ro_metadata', full_name='voldemort.VoldemortAdminRequest.get_ro_metadata', index=20,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='rebalance_state_change', full_name='voldemort.VoldemortAdminRequest.rebalance_state_change', index=21,
...
_REBALANCEPARTITIONINFOMAP.fields_by_name['replica_to_partition'].message_type = _PARTITIONTUPLE
_REBALANCEPARTITIONINFOMAP.fields_by_name['replica_to_delete_partition'].message_type = _PARTITIONTUPLE
...
_GETROMETADATAREQUEST.fields_by_name['type'].enum_type = _ROMETADATATYPE
_GETROMETADATARESPONSE.fields_by_name['ro_store_metadata'].message_type = _ROMETADATAMAP
_GETROMETADATARESPONSE.fields_by_name['error'].message_type = voldemort_client_pb2._ERROR
...
_VOLDEMORTADMINREQUEST.fields_by_name['get_ro_metadata'].message_type = _GETROMETADATAREQUEST
...
class ROMetadataMap(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _ROMETADATAMAP
  
  # @@protoc_insertion_point(class_scope:voldemort.ROMetadataMap)

class GetROMetadataRequest(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _GETROMETADATAREQUEST
  
  # @@protoc_insertion_point(class_scope:voldemort.GetROMetadataRequest)

class GetROMetadataResponse(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _GETROMETADATARESPONSE
